...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'rgba(255,255,255,0.07)', color: 'rgba(253,251,247,0.3)' },
          active: { scale: 1, backgroundColor: '#A02D23', color: '#A02D23' },
          complete: { scale: 1, backgroundColor: '#D4AF37', color: '#D4AF37' },
        }}
