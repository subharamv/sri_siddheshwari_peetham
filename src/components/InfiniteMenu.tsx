...
class InfiniteGridMenu {
  ...
  private discLocations!: {
    aModelPosition: number; aModelUvs: number; aInstanceMatrix: number;
    uWorldMatrix: WebGLUniformLocation | null; uViewMatrix: WebGLUniformLocation | null;
    uProjectionMatrix: WebGLUniformLocation | null; uCameraPosition: WebGLUniformLocation | null;
    uScaleFactor: WebGLUniformLocation | null; uRotationAxisVelocity: WebGLUniformLocation | null;
    uTex: WebGLUniformLocation | null; uFrames: WebGLUniformLocation | null;
    uItemCount: WebGLUniformLocation | null; uAtlasSize: WebGLUniformLocation | null;
  };
  ...
  private initTexture(): void {
    ...
    Promise.all(this.items.map(item => new Promise<HTMLImageElement>(resolve => {
      ...
      images.forEach((img, i) => {
        ...
        try { ctx.drawImage(img, x, y, cellSize, cellSize); } catch (_) { /* skip failed images */ }
      });
