...
const SWAMI_FULL_DATA: SwamiData[] = [
  {
    ...
    born: 'c. 1860, Numbalapuram, Tamilnadu',
    departed: '1943, Courtallam',
    birthplace: 'Numbalapuram (Thasakkudi), Alangulam, Tirunelveli District, Tamilnadu',
    parents: 'Sri Ponnaiah Pillai & Smt. Bhavani',
    ...
    story: [
      'Born around 1860 in the village of Numbalapuram (Thasakkudi) in Alangulam Taluka, Tirunelveli District, Sri Mouna Swamy was drawn early to the eternal. As a youth he spent countless hours in temples and in the company of wandering sages, absorbing the language of devotion and the stillness of the heart.',
      'His formal education became a pilgrimage into the spirit of Advaita Vedanta. Under the guidance of learned teachers, he mastered the principal Upanishads and the essence of Shaiva Siddhanta, then renounced conventional life to embrace the path of sannyasa and single-pointed surrender to the Supreme.',
      'Sri Mouna Swamy settled at Courtallam, a place of sacred springs and ancient shrines. There he adopted the vow of Mouna (permanent silence) as his highest discipline. He spoke only through gesture, written notes, and the quiet power of his presence, making his life itself a living teaching.',
      'In 1916 he established Sri Siddheswari Peetham as a centre for Vedic study, temple worship, and compassionate service. The Peetham became known for annadana (free food service), Veda instruction, and the preservation of rare Shaiva rituals, attracting devotees and seekers from across South India.',
      'Despite his silence, Sri Mouna Swamy served as a beacon of grace. Pilgrims found in him the calm strength of one who had gone beyond words, and scholars witnessed his devotion to dharma, discipline, and the continuity of the guru parampara.',
      'He attained Mahasamadhi in 1943 at Courtallam, leaving a sacred lineage and an institution that continues to preserve his silent flame and the spiritual heritage of Sri Siddheswari Peetham.',
    ],
    contributions: [
      { Icon: MapPin, title: 'Founded Sri Siddheswari Peetham', description: 'Established the sacred Peetham at Courtallam in 1916 as a centre of Advaita Vedanta, Shaiva worship, and service.' },
      { Icon: Leaf, title: 'Annadana Tradition', description: 'Instituted continuous free food service for pilgrims and the needy, making seva a living expression of the Peetham’s mission.' },
      { Icon: BookOpen, title: 'Veda Patasala Foundation', description: 'Created a Veda Patasala to ensure the uninterrupted transmission of chanting, Sanskrit learning, and scriptural study.' },
      { Icon: Heart, title: 'Silent Compassion', description: 'Demonstrated that profound love and spiritual guidance can flow through silence, gesture, and compassionate presence.' },
      { Icon: Star, title: 'Shaiva Siddhanta Preservation', description: 'Preserved temple rituals, devotional practices, and the sacred teachings of Shaiva Siddhanta during a time of social change.' },
      { Icon: Globe, title: 'Pilgrimage Sanctuary', description: 'Transformed the Courtallam hermitage into a revered pilgrimage sanctuary for seekers of dharma and peace.' },
    ],
    gallery: [
